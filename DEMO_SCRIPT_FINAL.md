...
> 
> *Notice the badge in the corner: **'Omnichannel State: Synced (Web/Mobile/Branch)'**. This means whether Kwame checks his balances on the Ecobank Mobile app, logs into online banking, or walks into the Ridge Branch, his Relationship Manager sees the exact same single source of truth in real time."*
...
> 
> *3. **Third, MoMo Commercial Float: GHS 145,000 per month.** MoMo is **Mobile Money** — MTN Mobile Money or Telecel Cash. Kwame is moving 145,000 Cedis every month through his phone as working capital for his business. Standard Western banking software treats this as invisible. Our platform captures it as a vital behavioral velocity signal — it tells us Kwame has high commercial cash generation.*
> 
> *4. **Fourth, EDC Asset Holdings: GHS 0.** EDC stands for **Enterprise Development Corporation** — Ecobank's own premier asset management and investment subsidiary. Notice it is zero, and the system flags it in red as **'Cross-Sell White Space'**. Kwame banks with Ecobank, but he has zero Cedis invested with Ecobank Asset Management. That is pure missed revenue for the bank."*
...
> 
> *Look at the three cards directly to the right of the gauge:*
> 
> *• **Real Inflation Cash Drag: -GHS 8,730 per month.** Ghana's central bank inflation rate is running around 21%. His CASA current account earns 2%. That 19% gap means Kwame is literally losing **8,730 Cedis of real purchasing power every single month** just by letting his cash sit idle. We don't hide this behind accounting terms — we show the exact monthly bleeding right on the screen.*
> 
> *• **Capital Flight / Maturity Risk: Matures in 4 Days.** Kwame holds GHS 350,000 in a 91-day Government Treasury Bill (T-Bill) that matures in exactly four days. When that principal pays out, that 350,000 Cedis becomes liquid cash. If our Relationship Manager doesn't call him today, that money will walk out the door to a competitor's fixed deposit.*
> 
...
👆 *Point to the 3 Scenario Preset cards at the top right.*

🗣️ **SAY THIS:**
> *"Question 10 requires live goal creation with multiple scenarios, and Question 13 requires adjusting scenario assumptions live. Here on Tab 3, we solve both.*
> 
> *Notice our three pre-configured Pan-African Market Presets:
> 1. **Ghana Retirement (GHS):** Blended 14.5% yield over 15 years in Ghanaian Cedis.
> 2. **Diaspora Endowment (USD):** 8.5% net yield in US Dollars for FX Domiciliary accounts.
> 3. **BRVM Succession (XOF):** 11.2% yield in West African CFA Francs, benchmarked against WAEMU sovereign bonds (BTP).*
> 
> *Each preset loads with the specific local currency, statutory tax treatment, and central bank inflation benchmark."*
...
> 
> *Now look at the four metric boxes above the chart:
> - Total Invested: **GHS 1,150,000**
> - Nominal Projected Value: **GHS 3,892,100**
> - **Real Purchasing Power: GHS 1,842,500**
> - Wealth Multiplier: **3.38x**
> 
> Look at the difference between **Nominal** (3.89 million) and **Real** (1.84 million). Most Western robo-tools show the client the 3.8 million number to excite them. But after 15 years of 9% African inflation, that 3.8 million Cedis only buys 1.84 million Cedis of goods! We display both transparently. This honesty is actually the RM's greatest cross-selling tool, because it proves to the client why they cannot afford to leave their money in low-yield savings accounts."*

---

### 💥 LIVE VALIDATION MOMENT 3: Zero-Latency Client-Side Recalculation
👆 *Grab the **"Expected Annual Return"** slider (currently 14.5%) and drag it smoothly up to **18.0%**.*

🗣️ **SAY THIS:**
> *"Watch the canvas chart on the right as I drag this return slider.*
> 
> *(Pause 2 seconds as the chart redraws smoothly).*
> 
> *The entire Monte Carlo fan chart redraws at **60 frames per second**. There is zero server lag, no spinning wheel, and no network latency. The mathematical compound interest model and stochastic volatility bands run entirely client-side in the browser."*
...
> - **The solid cyan line is P50:** The median expected outcome across 500 stochastic simulation runs.
> - **The solid gold line is the Real Value:** P50 discounted by local inflation.
> - **The shaded cyan band is the P10 to P90 Risk Fan:** 
>   - **P90 (the upper edge)** is the optimistic scenario — if African capital markets perform in the top 10% of historical volatility.
>   - **P10 (the lower edge)** is the conservative floor — 90% of all simulated market paths performed better than this line.
> 
> When Kwame asks, 'What is my downside if Ghana's economy suffers a shock?', the RM points directly to the P10 line."*
...
👆 *Point to the deployment status table on the right card.*

🗣️ **SAY THIS:**
> *"Question 11 asks for robo-advisory with visible regulatory guardrails. And before I click anything, let me give you the direct, honest answer that your evaluation committee is looking for:*
> 
> *Look at the table on the right:
> - In **Ghana**, our robo-suitability engine runs in a controlled pilot with EDC Stockbrokers under the **SEC Ghana Regulatory Sandbox (SEC Reg 34 - Investor Protection Directive)**.
> - In **WAEMU / Francophone West Africa**, the engine is staged for sandbox clearance with **CREPMF (Article 12 Portfolio Conduct)**.
> 
> **We do not claim unsupervised, fully autonomous algorithmic trading across Africa.** Why? Because neither the Bank of Ghana, SEC Ghana, nor CREPMF currently allows fully unsupervised retail automated rebalancing without human Relationship Manager sign-off. We deploy a **'Human-in-the-Loop' hybrid advisory model**, where the algorithm proposes, the compliance guardrail validates, and the RM confirms. Now let me demonstrate the guardrail in action."*

---

### 💥 LIVE VALIDATION MOMENT 4: The Hard-Block Intercept
👆 *In the dropdown **"Select Model Portfolio Strategy"**, select: **`Ecobank African Frontier Alpha (High-Beta Equities & Credit)`**.*

🗣️ **SAY THIS:**
> *"Ecobank African Frontier Alpha is our most aggressive strategy — it requires a minimum risk score of **75 out of 100**. Remember: Kwame Mensah's KYC risk score is **54 out of 100 (Moderate-Balanced)**.*
> 
> *Let's see what happens if an RM tries to allocate Kwame to this high-risk strategy."*

👆 *Click the big button: **`🛡️ Run Robo-Suitability Compliance Gate`**.*
*(A bold RED violation banner appears with "SUITABILITY VIOLATION: Hard Block Intercept").*

🗣️ **SAY THIS:**
> *"**Hard Block Intercept.** The system refuses the transaction.
> 
> Notice what it displays:
> - Client Risk Score: **54/100** vs. Required Strategy Minimum: **75/100**
> - Regulatory Mandate: **SEC Ghana Investor Protection Directive Reg 34(b)**
> - The execution button is disabled. 
> 
> An RM cannot bypass this check to chase commissions. Overriding this requires a formal Compliance Officer override with multi-factor authorization."*

---

### 💥 LIVE VALIDATION MOMENT 5: Simulating a Guardrail Breach
👆 *Click the button in the top right header: **`Switch Guardrails OFF (Simulate Breach)`**.*
*(The top banner turns RED: `REGULATORY GUARDRAILS: DISABLED (BREACH SIMULATION ACTIVE)`).*

🗣️ **SAY THIS:**
> *"We built this toggle specifically for your audit and evaluation team. When guardrails are switched OFF to simulate a rogue actor or system bypass, the entire UI enters a high-visibility red alert state.
> 
> Every regulatory examiner immediately sees that compliance enforcement is unlinked. Nothing is hidden behind silent debug flags."*

👆 *Click **`Switch Guardrails ON (Enforce Compliance)`** to restore the green banner.*

🗣️ **SAY THIS:**
> *"Switch it back ON — green, enforced, audit-verified."*

---

## 📁 TAB 5: African Market AI Evidence & Live ML Lab (Q12 Focus)

### Scene 1: Rejecting "AI Washing" with 23,524 Real Records
👆 *Click **"African Market AI Evidence"** (Tab 5).*
👆 *Point to the 5 metric boxes across the top.*

🗣️ **SAY THIS:**
> *"Question 12 is where we separate genuine enterprise AI from marketing slides. Many vendors claim their AI is 'trained on African data' without being able to produce a single record or validation artifact.*
> 
> *Look at the verified metrics across the top:
> - **23,524 Genuine Empirical Records:** Sourced from FinMark Trust, Zindi, and World Bank financial inclusion surveys across Kenya, Rwanda, Tanzania, and Uganda.
> - **20% Stratified Holdout Test Set:** 4,705 records that the model never saw during training, used strictly for out-of-sample validation.
> - **ROC-AUC of 0.8789:** ROC-AUC measures classification quality — 0.5 is a coin toss, 1.0 is perfection. Our model scores **0.8789**.
> - **The Western Model Comparison:** When a standard generic Western wealth propensity model is evaluated on this same African dataset, its ROC-AUC collapses to **0.6140**.
> 
> That is a **26.5 percentage point performance advantage**. Why does the Western model fail? Because Western models look for 401(k) retirement contributions, credit card revolving debt, and FICO scores. They have zero understanding of Mobile Money float, cash agricultural cycles, or dual-currency domiciliary hedging."*
...
🗣️ **SAY THIS:**
> *"Now, let me demonstrate our dynamic machine learning sandbox. Notice the green **'AUTO'** badge on the button. You don't even have to click the button — the system listens to every field change, sends the payload to the Python backend in real time, and scores it in 600 milliseconds.*
> 
> *Let's test it live. Watch the right side."*

👆 *In the form, change **Job Type** from `Formally employed Private` to **`Self employed`**.*
*(Wait ~600ms. The input field flashes cyan, the score animates, and the **'📊 Before → After Comparison'** panel appears below!)*

🗣️ **SAY THIS:**
> *"Look at what just happened:
> 
> 1. **The Python model scored the profile automatically in 600ms.**
> 2. **Look at the 'Before → After Comparison' panel that appeared below:**
>    - It shows the exact delta between the previous prediction and the new one.
>    - It highlights the changed field: Job Type changed from 'Formally employed Private' to 'Self employed'.
> 3. **Read the Scenario Story at the bottom:**
>    *'Transitioning to Self-employed introduces variable cash flows. In East and West African banking, self-employed micro-entrepreneurs rely heavily on Mobile Money liquidity buffers, adjusting their formal banking propensity.'*
> 
> The system doesn't just return a raw number — it translates the machine learning delta into commercial African economic context."*
...
🗣️ **SAY THIS:**
> *"Let's take a real survey respondent from Rwanda — click 'Run in Model'. The demographic features transfer instantly to the inference engine, execute against the joblib pipeline, and return the ground-truth comparison.*
> 
> *Below that, we show the empirical **ROC Curve** across 32 decision thresholds and the full **Confusion Matrix** (3,941 True Negatives, 249 True Positives) audited directly from the test split."*
...
🗣️ **SAY THIS:**
> *"If Bank of Ghana model validators, BCEAO inspectors, or Ecobank risk committees require documentation, we provide this formal **AI Model Card**:
> - Training methodology (LightGBM / GBDT)
> - African data provenance (24,500 longitudinal customer interactions)
> - Fairness metrics across gender and urban/rural divides
> - Population Stability Index (PSI) of 0.041 across 36 months, proving zero model drift.
> 
> You can click 'Print / Export PDF' to generate the regulatory compliance dossier instantly."*

👆 *Click the `&times;` close button to exit the modal.*

---

## 🎯 GRAND FINALE: Create a Brand-New Client From Scratch Live!

👆 *Navigate back to **Tab 1: Client 360°**.*
👆 *Click the **`+ New Client`** button in the left sidebar.*
*(The "Create Custom Client Profile" modal pops up).*
...
- **Country:** `Côte d'Ivoire / WAEMU (XOF)`
- **Wealth Segment:** `High Net Worth (HNW) - Private Wealth`
- **Relationship Manager:** `Didier Yao (Plateau Branch, Abidjan)`
- **CASA Liquid Cash:** `250000000` (250 million XOF ≈ USD 410,000)
- **FX Domiciliary:** `75000` ($75,000 USD)
- **T-Bill / Fixed Deposit:** `100000000` (100 million XOF) maturing in `5` days
- **MoMo Monthly Float:** `35000000` (35 million XOF)
- **Existing EDC Balance:** `0`
- **Risk Tolerance:** Drag slider to `42 / 100` (Conservative)

👆 *Click **`✓ Create Client & Run Live AI`**.*
...
> 
> Every number on this screen is computed dynamically at runtime. Thank you, and I welcome your questions."*
